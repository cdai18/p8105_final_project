...
Challenges:
  ...
  * Our chosen dataset is extremely large and contains data from the last 13 years. We anticipate it will be difficult to parse through filter for the data we need.
  * There are a lot of location types we couldn’t potentially use as a predictor for rat sightings, so it may be difficult to narrow them down to what might be most significant.
